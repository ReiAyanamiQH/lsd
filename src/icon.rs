...
impl Icons {
    ...
    fn get_default_icons_by_name() -> HashMap<&'static str, &'static str> {
        ...
        m.insert("gitignore_global", "\u{f1d2}"); // ""
    ...
    fn get_default_icons_by_extension() -> HashMap<&'static str, &'static str> {
        ...
        m.insert("bash_history", "\u{e795}");  //""
        m.insert("bash_profile", "\u{e795}");  //""
        m.insert("bashrc", "\u{e795}"); //""
        m.insert("bat", "\u{f17a}"); // ""
        ...
        m.insert("db", "\u{f1c0}"); // ""
        m.insert("diff", "\u{f695}"); //""
        m.insert("patch", "\u{f695}"); //""
        m.insert("doc", "\u{f1c2}"); // ""
        ...
        m.insert("so", "\u{fc29}"); //
        m.insert("a", "\u{fc29}"); //
        m.insert("qcow2", "\u{fc29}"); //
        m.insert("box", "\u{fc29}"); //
        m.insert("AppImage", "\u{fc29}"); //
        m.insert("h", "\u{f0fd}"); // ""
        m.insert("hbs", "\u{e60f}"); // ""
        m.insert("hpp", "\u{f0fd}"); // ""
        m.insert("hs", "\u{e777}"); // ""
        ...
        m.insert("yml", "\u{e60b}"); // ""
        m.insert("zsh", "\u{e795}"); //""
        m.insert("zsh-theme", "\u{e795}");  //""
        m.insert("zshrc", "\u{e795}");  //""
        //not find org icon, use tmp
        m.insert("org", "\u{f2ad}");  //""
        m.insert("org_archive", "\u{f2ad}");  //""
